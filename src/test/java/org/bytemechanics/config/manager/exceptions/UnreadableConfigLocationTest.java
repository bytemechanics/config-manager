 ...
 * @author afarre
 */
public class UnreadableConfigLocationTest {
    
    @BeforeAll
    public static void setup() throws IOException {
        System.out.println(">>>>> UnreadableConfigLocationTest >>>> setupSpec");
        try ( InputStream inputStream = UnreadableConfigLocationTest.class.getResourceAsStream("/logging.properties")) {
    ...
    public void testMessageConstructor(final String _message,final Throwable _exception) {
        UnreadableConfigLocation instance = new UnreadableConfigLocation(_message,_exception);
    ...
    public void testUriConstructor(final String _uri,final Throwable _exception) {
        UnreadableConfigLocation instance = new UnreadableConfigLocation(Optional.ofNullable(_uri)
                                                                                    .map(LambdaUnchecker.uncheckedFunction(URI::new))
                                                                                    .orElse(null)
                                                                        ,_exception);
        Assertions.assertAll(() -> Assertions.assertEquals(SimpleFormat.format(UnreadableConfigLocation.MESSAGE, _uri),instance.getMessage())
                            ,() -> Assertions.assertEquals(_exception,instance.getCause()));
    }
}
