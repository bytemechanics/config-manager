...
public class UnwritableConfigLocation extends RuntimeException{
     ...
     */
    public UnwritableConfigLocation(final URI _location,final Throwable _cause) {
     ...
     * @param _cause underlaying exception
     */
    public UnwritableConfigLocation(final String _message,final Throwable _cause) {
